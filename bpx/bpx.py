...
class BpxClient:
    ...
    def deposits(self):
        return requests.get(
            url=f"{self.url}wapi/v1/capital/deposits",
            proxies=self.proxies,
    ...
    def depositAddress(self, chain: str):
        ...
        return requests.get(
            url=f"{self.url}wapi/v1/capital/deposit/address",
            proxies=self.proxies,
            params=params,
    ...
    def withdrawals(self, limit: int, offset: int):
        ...
        return requests.get(
            url=f"{self.url}wapi/v1/capital/withdrawals",
            proxies=self.proxies,
            params=params,
    ...
    def orderHistoryQuery(self, symbol: str, limit: int, offset: int):
        ...
        return requests.get(
            url=f"{self.url}wapi/v1/history/orders",
            proxies=self.proxies,
            params=params,
    ...
    def fillHistoryQuery(self, symbol: str, limit: int, offset: int):
        ...
        return requests.get(
            url=f"{self.url}wapi/v1/history/fills",
            proxies=self.proxies,
            params=params,
    ...
    def ExeOrder(self, symbol, side, orderType, timeInForce, quantity, price):
        ...
        # print("req", json.dumps(params), "resp", ret.status_code, ret.text)
        return ret.json()
